...
def build_agent_instruction(problem_text: str) -> str:
    return AGENT_INSTRUCTION.format(problem=problem_text)

AGENT_INSTRUCTION = """
You are a professional software‐engineer interviewer with 20 years of experience and you will make this interview {difficulty}.
